...
import com.example.newqrscanner.User.EventListAdapter;
...
public class AdminEventList extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.admineventrecycle);
        qrModuleList = new ArrayList<>();
        GridLayoutManager layoutManager = new GridLayoutManager(this,1);
        recyclerView.setLayoutManager(layoutManager);
        admineventListAdapter = new AdminEventListAdapter(this,qrModuleList);
        recyclerView.setAdapter(admineventListAdapter);
        reference = FirebaseDatabase.getInstance().getReference("QRLIST");
        AlertDialog.Builder buildert = new AlertDialog.Builder(AdminEventList.this);
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                dialog.dismiss();
                Toast.makeText(AdminEventList.this, "error", Toast.LENGTH_SHORT).show();
                Toast.makeText(AdminEventList.this, "error"+error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
